                ...
                filteredDebates.map((data, idx) => (
                  ...
                  >
                    <div className="p-4">
                      ...
                      <button className="px-2 py-2 bg-green-600 text-white rounded-lg font-semibold shadow-md hover:scale-105 transition-transform">
                        <Pen/>
                      </button>
                      <button className="px-2 py-2 bg-red-600 text-white rounded-lg font-semibold shadow-md hover:scale-105 transition-transform">
                        <Trash/>
                      </button>
                      </div>
                    </div>
